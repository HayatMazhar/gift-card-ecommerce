...
namespace Bamboo.Api.Extensions
{
    public static class ServiceExtensions
    {
        public static void AddSwaggerExtension(this IServiceCollection services)
        {
            ...
            {
                //c.IncludeXmlComments(string.Format(@"{0}\Bamboo.WebApi.xml", AppDomain.CurrentDomain.BaseDirectory));
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "v1",
                    Title = "Bamboo API",
                    Description = "This will help to find out all the api endpoint and  its response in Bamboo",
